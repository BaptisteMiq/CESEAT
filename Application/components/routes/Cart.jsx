...
const Cart = props => {
  ...
  var getCarts = async () => {
    ...
    if (response) {
      const carts = response.data.myCarts;
  ...
  return (
    <IonPage className="overflow-y-auto mb-5 flex flex-col">
      <div className="mb-5 flex flex-wrap align-center justify-center flex-col">
        {carts !== null && (
          <>
                ...
                {carts.map(cart => (
                  <>
                    <div className="justify-center align-center items-center flex flex-auto mt-10 mb-5">
                      <HeadingLevel>
                        <Heading styleLevel={4}>Panier de <u>{cart.restaurant.name}</u></Heading>
                      </HeadingLevel>
                    </div>
                  ...
                  /> */}
                          ...
                          <div className="w-1/2 flex flex-row flex-wrap">
                            <div
                              className={
                                isPlatform('desktop') ? 'w-2/6 self-center' : 'w-1/2 self-center'
                              }
                            >
