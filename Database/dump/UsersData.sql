...
INSERT INTO `mydb`.`User` (`ID`,`Firstname`,`Lastname`,`Password`,`Mail`,`PhoneNumber`,`Avatar`,`SponsorCode`,`HasAcceptedGDPR`,`BillingAddress_ID`,`DeliveryAddress_ID`,`Role_ID`,`CreatedAt`) VALUES (3,'Julien','Lorenzo','$2b$10$iW19kBygkqEdF/L0aCE0.et/3tP/KZU.Pv9DxdxEJMipZTEphLC4q','livreur@test.com','06000000000','/julien.jpeg','TAEZD',0,NULL,NULL,3,'2022-06-29 15:17:18');
